;(function(context) {
     ...
     * @return {FormBuilder} FormBuilder The instance
     */
    ...
    /**
     * Static defaults fields : can be change for render
     */
     ...
     */
    FormBuilder.editDefaultField = function(key, attributes) {
        if(typeof key == 'string') {
            ...
            for(var i in FormBuilder.defaultsFields)
                if(FormBuilder.defaultsFields.hasOwnProperty(i) && (key != undefined && (typeof key == 'string' && i == key || key.indexOf(i) >= 0)))
    ...
    FormBuilder.getField = function(key) {
        if(FormBuilder.defaultsFields[key] != undefined){
            return FormBuilder.defaultsFields[key].cloneNode(true);
        }
        throw new Error('The field ' + key + ' isn\'t know.');
    };

    /**
     * Constructor of Field
     * @return {FormBuilder} Field the instance
     */
    FormBuilder.prototype.Field = function() {
         ...
         * @param {boolean} addToStream (default: true) Add the field to the fields list
         ...
         * @param {object} attributes New attributes of the field
         * @return {object} field The added field
         */
        ...
        /**
         * Adds a checkbox element to the list of fields
         * @param {string} name Name or attributes of the field
         * @param {string} value Value or attributes of the field
         * @return {object} field The added checkbox field
         */
        ...
        /**
         * Adds a radio element to the list of fields
         * @param {string} name Name or attributes of the field
         * @param {string} value Value or attributes of the field
         * @return {object} field The added radio field
         */
        this.radio = function(name, value) {
            var radio = this.input('radio', {
                value: value,
                name: name
            });
        ...
        /**
         * Use in chain, to add a label to a field
         * @param {string} label The name of the label
         */
        ...
        this.selected.selectValue = function(value) {
            if(arguments.length > 1){
                ...
                this.form.updateField(this.node.name, null).children[ind].selected = "selected";
            }
    ...
    /**
     * Constructor of Form
     * @return {FormBuilder} Form the instance
     */
        ...
        this.get = function() {
            ...
            form.onsubmit = function(evt) {
                ...
                var map = function(el) {
                    ...
                    if(v != '' && el.nodeName.toLowerCase() == 'select') {
                        v = [].slice.call(el.selectedOptions).map(function(e){
                            return e.value;
                        });
                    }
                ...
                that.onSubmit(evt, that.fields.filter(filter).map(map));
     ...
     * @return {FormBuilder} Validator the instance
     */
     ...
     * @return {FormBuilder} Event the instance
     */
